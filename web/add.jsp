...
<form id="form"  class="myform form-inline" onsubmit="return false" >
    ...
    <div class="form-group">
        <button onclick="addStudent()" class="btn btn-primary">添加</button>
    </div>
    <div class="form-group">
...
<script>
    function addStudent(){
        console.log("进入成功")
        $.ajax({
            url:"http://localhost:8080/Query_war_exploded/add",
            type:"POST",
            data:$('#form').serialize(),
            success:function(result){
                ...
                console.log(url)
                window.location.href="/Query_war_exploded/"+url;
